...
export default class Chat {
  ...
  static get markup() {
    return `
      <div class="container">
        ...
        <div class="chat__header">WELCOME!</div>
        ...
        <div class="chat__area">
          <div class="chat__messages-container"></div>
            <form class="form__message">
              <input class="chat__messages-input" placeholder="Type your message here"></input>
            </form>
  ...
  renderMessage(data) {
    ...
    const msgHTML = `
      <div class="message__container-${fromUser ? `yourself` : `interlocutor`}">
